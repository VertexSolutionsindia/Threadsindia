<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Customer_wise.aspx.cs" Inherits="Admin_Stock_Clearance" %>
...
<%--                              <li>
  ...
  <div class="panel-body">
   <div class="col-md-12">
    ...
    <br /> <div class="form-group"><label class="col-lg-3">Customer Name</label>
 ...
 <asp:GridView ID="GridView1" runat="server" Width="100%" CellPadding="4" 
       ...
       <Columns>
           ...
           <asp:BoundField HeaderText="Particulars" DataField="status" />
             ...
             <asp:BoundField HeaderText="Total Outstanding amount" DataField="outstanding" DataFormatString="{0:#,##0.00}" />  
