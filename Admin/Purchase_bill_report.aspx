<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Purchase_bill_report.aspx.cs" Inherits="Admin_Purchase_bill_report" %>
            ...
            <div class="container-fluid">
                ...
                <div class="search" style="display: none;">
                  ...
                  <div class="navbar-header">
                    ...
                    <a class="navbar-brand" href="#">Threads india</a>
                </div>
...
<%--                              <li>
  ...
  <div class="panel-body">
   <div class="col-md-6">
    ...
    <br /> <div class="form-group"><label class="col-lg-3 control-label">Supplier Name</label>
...
<div class="container">
 ...
 <asp:GridView ID="GridView1" runat="server" CssClass="red" Width="100%" CellPadding="3" 
       ...
       <Columns>
               ...
               <asp:BoundField HeaderText="Bill No" DataField="purchase_invoice"  >
