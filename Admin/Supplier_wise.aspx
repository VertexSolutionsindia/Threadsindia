<%@ Page Language="C#" AutoEventWireup="true"  CodeFile="Supplier_wise.aspx.cs" Inherits="Admin_Staff_Entry" %>
...
<asp:Button ID="Button4" runat="server"  Text="ADD" class="btn btn-primary"></asp:Button> <span aria-hidden="true" class="glyphicon glyphicon-plus"></span> </a>
  ...
  <div class="panel-body">
   <div class="col-md-12">
    ...
    <br /> <div class="form-group"><label class="col-lg-3">Supplier Name</label>
   ...
   <asp:DropDownList ID="DropDownList1" runat="server" AutoPostBack="true"
           ...
           <asp:Button ID="Button8" runat="server" Text="Report" onclick="Button8_Click"></asp:Button>
              </div>
          
           <div class="col-lg-3">
         
            <asp:Button ID="Button2" runat="server" Text=" Get all supplier Outstanding" 
 ...
 <asp:GridView ID="GridView1" runat="server" Width="100%" CellPadding="4" 
       ...
       <Columns>
           ...
           <asp:BoundField HeaderText="Particulars" DataField="status" />
             ...
             <asp:BoundField HeaderText="Bill amount" DataField="Estimate_value" DataFormatString="{0:#,##0.00}" />
            
             <asp:BoundField HeaderText="Outstanding amount" DataField="outstanding" DataFormatString="{0:#,##0.00}" />  
       ...
       <SortedDescendingHeaderStyle BackColor="#6F8DAE" />
           ...
           Text="Export to pdf" onclick="Button6_Click"></asp:Button>
           <br />
   ...
   <ContentTemplate>
       ...
       <RowStyle Height="40px" />
                     ...
                     <asp:Button ID="Button7" runat="server" Text="Export to Excel" 
           onclick="Button7_Click"></asp:Button>
                   <asp:Button ID="Button3" runat="server" Text="Export to pdf" 
