...
<asp:Button ID="Button4" runat="server"  Text="ADD" class="btn btn-primary"></asp:Button> <span aria-hidden="true" class="glyphicon glyphicon-plus"></span> </a>
   ...
   <asp:DropDownList ID="DropDownList2" runat="server">
    ...
    <asp:Button ID="Button9" runat="server" Text="Print" OnClientClick="Print()" onclick="Button9_Click"></asp:Button>
                            <asp:UpdatePanel ID="UpdatePanel9" runat="server">
   <ContentTemplate>

    <asp:Button ID="Button7" runat="server" class="btn-primary" Width="70px" Height="30px"  Text="<" OnClick="Button7_Click" Visible="false"></asp:Button>
     <asp:Button ID="Button12" runat="server" class="btn-primary" Width="70px" Height="30px"  Text=">" onclick="Button12_Click" Visible="false" ></asp:Button>
 ...
 <asp:TextBox ID="TextBox6" runat="server" AutoPostBack="true" class="form-control input-x2 dropbox" 
  ...
  <Triggers>
   ...
   <ContentTemplate>
  <asp:Button ID="Button8" runat="server" Text="ADD" onclick="Button8_Click" OnClientClick="Confirm()"></asp:Button>
  </ContentTemplate>
