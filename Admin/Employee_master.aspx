<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Employee_master.aspx.cs" Inherits="Admin_Cutomer_type" %>
...
<asp:Button ID="Button4" runat="server"  Text="ADD" class="btn btn-primary"></asp:Button> <span aria-hidden="true" class="glyphicon glyphicon-plus"></span> </a>
  ...
  <asp:Panel ID="Panel1" runat="server" class="panel0" BorderColor="Black" BorderStyle="Solid" BackColor="White" Direction="LeftToRight" style="display:none" 
                         HorizontalAlign="Left" ScrollBars="Both" Width="1000px" Height="420px">
   <div style="padding:12px; border:1px solid #e5e5e5;   border-radius:10px; background-color:#E6E6FA;color:#233445; font-size:15px; font-weight:400px; font-family: 'Open Sans',"HelveticaNeue", "Helvetica Neue", Helvetica, Arial,sans-serif; ">
        ...
        <br />   
                   ...
                   <asp:BoundField HeaderText="Employee Id" DataField="emp_id" HeaderStyle-CssClass="red" FooterStyle-CssClass="red" ItemStyle-CssClass="red"  />
            
               <asp:BoundField HeaderText="Employee Name" DataField="emp_name" HeaderStyle-CssClass="red" FooterStyle-CssClass="red" ItemStyle-CssClass="red"  />
                 <asp:BoundField HeaderText="Gender" DataField="gender" HeaderStyle-CssClass="red" FooterStyle-CssClass="red" ItemStyle-CssClass="red"  />
                    <asp:BoundField HeaderText="DOB" DataField="dob"  DataFormatString="{0:dd/MM/yyyy}" HeaderStyle-CssClass="red" FooterStyle-CssClass="red" ItemStyle-CssClass="red"    />
                  
                    <asp:BoundField HeaderText="DOJ" DataField="doj" DataFormatString="{0:dd/MM/yyyy}" HeaderStyle-CssClass="red" FooterStyle-CssClass="red" ItemStyle-CssClass="red"  />
                  
                    <asp:BoundField HeaderText="Department" DataField="dep" HeaderStyle-CssClass="red" FooterStyle-CssClass="red" ItemStyle-CssClass="red"  />
                  
                    <asp:BoundField HeaderText="Designation" DataField="des" HeaderStyle-CssClass="red" FooterStyle-CssClass="red" ItemStyle-CssClass="red"  />
  ...
  <asp:ModalPopupExtender ID="ModalPopupExtender1" runat="server" TargetControlID="Button11" PopupControlID="Panel1" runat="server" CancelControlID="ImageButton4" BackgroundCssClass="modelbackground"></asp:ModalPopupExtender>
   ...
   <ContentTemplate>
                           <asp:Button ID="Button9" runat="server" Text="Button" style="display:none"></asp:Button>
  <asp:Panel ID="Panel2" runat="server" class="panel0" BorderColor="Black" BorderStyle="Solid" BackColor="White" Direction="LeftToRight" style="display:none" 
                         HorizontalAlign="Left" ScrollBars="Both" Width="500px" Height="420px">
   <div style="padding:12px; border:1px solid #e5e5e5;   border-radius:10px; background-color:#E6E6FA;color:#233445; font-size:15px; font-weight:400px; font-family: 'Open Sans',"HelveticaNeue", "Helvetica Neue", Helvetica, Arial,sans-serif; ">
                     <h3 style="font-size:20px; " class="control-label"> Add new head of department  <asp:ImageButton ID="ImageButton1" runat="server" ImageUrl="~/exit11.png" width="30px" height="30px" style="float:right" /></h3>
      ...
      <div class="tablestyles">
        ...
        <tr>
        <td>
            <asp:Label ID="Label15" runat="server" class="col-lg-6 control-label" Width="100px" Text="Head Id"></asp:Label></td>
        <td>
            <asp:Label ID="Label16" runat="server" Text=""></asp:Label></td>
        </tr>
        <tr>
        <td>
            <asp:Label ID="Label17" runat="server" class="col-lg-6 control-label" Width="200px" Text="Head Of department"></asp:Label></td>
        <td>
      ...
      <ContentTemplate>
            <asp:Button ID="Button10" runat="server" CssClass="btn-primary"  Text="ADD" OnClick="Button10_Click"  />
              </ContentTemplate>
  ...
  <asp:ModalPopupExtender ID="ModalPopupExtender2" runat="server" TargetControlID="Button9" PopupControlID="Panel2" runat="server" CancelControlID="ImageButton1" BackgroundCssClass="modelbackground"></asp:ModalPopupExtender>
  ...
  <div class="panel-body">
   <div class="col-md-6">
                 <div class="panel-body">
                           <div class="form-horizontal">
                               ...
                               <div class="form-group"><label class="col-lg-3 control-label">Employee Id</label>
   ...
   <ContentTemplate>
                                <asp:DropDownList ID="DropDownList1"  class="form-control input-x2 dropbox"  runat="server">
                ...
                <asp:AsyncPostBackTrigger ControlID="Button5" EventName="Click"  />
                  <asp:AsyncPostBackTrigger ControlID="Button2" EventName="Click"  />
                     <asp:AsyncPostBackTrigger ControlID="Button12" EventName="Click"  />
                                ...
                                <div class="form-group">  <label class="col-lg-3 control-label">DOJ</label>
                              
                                    <div class="col-lg-9">
                                     <asp:UpdatePanel ID="UpdatePanel10" runat="server">
   <ContentTemplate>
   <asp:TextBox ID="TextBox5" runat="server" class="form-control input-x2 dropbox"></asp:TextBox>
                               <asp:CalendarExtender ID="CalendarExtender1" runat="server" TargetControlID="TextBox5"></asp:CalendarExtender>
                                    </ContentTemplate>
                                     <Triggers>
                                      <asp:AsyncPostBackTrigger ControlID="Button7" EventName="Click"  />
                <asp:AsyncPostBackTrigger ControlID="Button5" EventName="Click"  />
                ...
                <asp:AsyncPostBackTrigger ControlID="Button5" EventName="Click"  />
                  <asp:AsyncPostBackTrigger ControlID="Button2" EventName="Click"  />
                     <asp:AsyncPostBackTrigger ControlID="Button12" EventName="Click"  />
                                 ...
                                 <div class="form-group">  <label class="col-lg-3 control-label">Commission amount</label>
