<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Winding_receipt.aspx.cs" Inherits="Admin_Sales_report" %>
...
<asp:Button ID="Button4" runat="server"  Text="ADD" class="btn btn-primary"></asp:Button> <span aria-hidden="true" class="glyphicon glyphicon-plus"></span> </a>
  ...
  <asp:BoundField DataField="Net_Wt" HeaderText="Nett Wt" />
   ...
   <ContentTemplate>
                                      <asp:Button ID="Button8" runat="server" Text="Get" onclick="Button8_Click"></asp:Button>
                                         </ContentTemplate>
...
<asp:TemplateField ItemStyle-Width = "100px"  HeaderText = "wendingdly no" HeaderStyle-CssClass="col-lg-3 control-label" 
    ...
    <ItemTemplate>
        ...
        <asp:Label ID="lblweddly" runat="server" Text='<%# Eval("wed_invoice")%>'></asp:Label>

    </ItemTemplate>

    <EditItemTemplate>

        <asp:TextBox ID="txtwedly" runat="server" Width="200px" Text='<%# Eval("wed_invoice")%>'></asp:TextBox>
...
<asp:TemplateField ItemStyle-Width = "100px"  HeaderText = "Boxes" HeaderStyle-CssClass="col-lg-3 control-label" 
    ...
    <ItemTemplate>
        ...
        <asp:Label ID="lblboxes" runat="server" Text='<%# Eval("boxes")%>' ></asp:Label>

    </ItemTemplate>

    <EditItemTemplate>

        <asp:TextBox ID="txtboxes" runat="server" Width="70px" AutoPostBack="true" Text='<%# Eval("boxes")%>'
            ></asp:TextBox>
  ...
  <asp:TemplateField ItemStyle-Width = "100px"  HeaderText = "Cones" HeaderStyle-CssClass="col-lg-3 control-label" 
    ...
    <EditItemTemplate>
        ...
        <asp:TextBox ID="txtcones" runat="server" Width="70px" AutoPostBack="true"  Text='<%# Eval("cones")%>'
            ontextchanged="txtcones_TextChanged" ></asp:TextBox>
...
<asp:TemplateField ItemStyle-Width = "100px"  HeaderText = "Gross Wt" HeaderStyle-CssClass="col-lg-3 control-label" 
    ...
    <EditItemTemplate>
        ...
        <asp:TextBox ID="txgrosswt" runat="server" Width="70px"  Text='<%# Eval("gross_wt")%>'  ></asp:TextBox>
...
<asp:TemplateField ItemStyle-Width = "100px"  HeaderText = "Nett Wt" HeaderStyle-CssClass="col-lg-3 control-label" 
    ...
    <ItemTemplate>
        ...
        <asp:Label ID="lblnetwt" runat="server" Text='<%# Eval("nett_wt")%>'></asp:Label>

    </ItemTemplate>

    <EditItemTemplate>

        <asp:TextBox ID="txtnetwt" runat="server" Width="70px"  Text='<%# Eval("nett_wt")%>'></asp:TextBox>
                  ...
                  <asp:AsyncPostBackTrigger ControlID="Button2" EventName="Click"  />
                     <asp:AsyncPostBackTrigger ControlID="Button12" EventName="Click"  />
                         <asp:AsyncPostBackTrigger ControlID="GridView1"   />
                                  ...
                                  <div class="form-group">  <label class="col-lg-3 control-label">Total Gross Wt</label>
