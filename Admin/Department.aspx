<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Department.aspx.cs" Inherits="Admin_Department_Entry" %>
...
<asp:Button ID="Button4" runat="server"  Text="ADD" class="btn btn-primary"></asp:Button> <span aria-hidden="true" class="glyphicon glyphicon-plus"></span> </a>
  ...
  <asp:Panel ID="Panel1" runat="server" class="panel0" BorderColor="Black" BorderStyle="Solid" BackColor="White" Direction="LeftToRight" style="display:none" 
   ...
   <div style="padding:12px; border:1px solid #e5e5e5;   border-radius:10px; background-color:#E6E6FA;color:#233445; font-size:15px; font-weight:400px; font-family: 'Open Sans',"HelveticaNeue", "Helvetica Neue", Helvetica, Arial,sans-serif; ">
                   ...
                   <asp:BoundField HeaderText="Department Id" DataField="dep_id"  HeaderStyle-CssClass="red" FooterStyle-CssClass="red" ItemStyle-CssClass="red"  />
           
               <asp:BoundField HeaderText="Department Name" DataField="dep_name"  HeaderStyle-CssClass="red" FooterStyle-CssClass="red" ItemStyle-CssClass="red" />
                 <asp:BoundField HeaderText="Head Of department" DataField="head_dep_name"  HeaderStyle-CssClass="red" FooterStyle-CssClass="red" ItemStyle-CssClass="red" />
   ...
   <div class="col-md-6">
                 <div class="panel-body">
                           <div class="form-horizontal">
                               ...
                               <div class="form-group"><label class="col-lg-3 control-label">Department Id</label>
                ...
                <asp:AsyncPostBackTrigger ControlID="Button5" EventName="Click"  />
                  <asp:AsyncPostBackTrigger ControlID="Button2" EventName="Click"  />
                     <asp:AsyncPostBackTrigger ControlID="Button12" EventName="Click"  />
                                 ...
                                 <div class="form-group">  <label class="col-lg-3 control-label">Head of the department</label>
                ...
                <asp:AsyncPostBackTrigger ControlID="Button5" EventName="Click"  />
                  <asp:AsyncPostBackTrigger ControlID="Button2" EventName="Click"  />
                     <asp:AsyncPostBackTrigger ControlID="Button12" EventName="Click"  />
                                      ...
                                      <div class="col-lg-2">
                                   <asp:Button ID="Button8" runat="server" Text="New" OnClick="Button8_Click"></asp:Button>
                                  </div>
