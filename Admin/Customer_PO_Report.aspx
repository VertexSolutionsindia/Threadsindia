<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Customer_PO_Report.aspx.cs" Inherits="Admin_Customer_PO_Report" %>
...
<div class="container">
 ...
 <asp:GridView ID="GridView1" runat="server" CssClass="red" Width="100%" CellPadding="3" 
       ...
       <Columns>
               ...
               <asp:BoundField HeaderText="Po Invoice No" DataField="po_invoice"  >
           ...
           <asp:BoundField HeaderText="Customer Name" DataField="customer">
             ...
             <asp:TemplateField HeaderText="Total Qty" HeaderStyle-CssClass="get" ItemStyle-CssClass="get">
                    <ItemTemplate>
                        <asp:Label ID="lbltotalqty" runat="server" Text='<%# Eval("Total_qty")%>' />
                    </ItemTemplate>
                    <FooterTemplate>
