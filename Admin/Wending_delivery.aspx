<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Wending_delivery.aspx.cs" Inherits="Admin_Sales_entry_wholesales" %>
...
<asp:Button ID="Button4" runat="server"  Text="ADD" class="btn btn-primary"></asp:Button> <span aria-hidden="true" class="glyphicon glyphicon-plus"></span> </a>
   ...
   <div class="col-md-6">
                 <div class="panel-body">
                           <div class="form-horizontal">
                               ...
                               <div class="form-group"><label class="col-lg-3 control-label">Wending No</label>
 ...
 <asp:Label ID="Label3" runat="server" Text="Label"></asp:Label>
  ...
  <asp:DropDownList ID="DropDownList3" runat="server" AutoPostBack="true"  
           class="form-control input-x2 dropbox" 
           onselectedindexchanged="DropDownList3_SelectedIndexChanged1"   ></asp:DropDownList>
  </ContentTemplate>
                                     <Triggers>
 ...
 <asp:DropDownList ID="DropDownList2" runat="server" 
   ...
   <div class="col-md-2"><h3>Cones</h3>
 ...
 <asp:TextBox ID="TextBox6" runat="server" AutoPostBack="true" 
  ...
  <Triggers>
    ...
    <div class="col-md-2"><h3>Gross Wt</h3>
 ...
 <asp:TextBox ID="TextBox2" runat="server" class="form-control input-x2 dropbox"></asp:TextBox>
  ...
  <div class="col-md-1"><h3>Net Wt</h3>
 ...
 <asp:TextBox ID="TextBox5" runat="server" AutoPostBack="true" class="form-control input-x2 dropbox" 
  ...
  <Triggers>
   ...
   <ContentTemplate>
  <asp:Button ID="Button8" runat="server" Text="ADD" onclick="Button8_Click"></asp:Button>
  </ContentTemplate>
...
<asp:TemplateField ItemStyle-Width = "100px"  HeaderText = "lot" HeaderStyle-CssClass="col-lg-3 control-label" 
        FooterStyle-CssClass="col-lg-3 control-label">
    ...
    <EditItemTemplate>
        ...
        <asp:TextBox ID="txtlot" runat="server" Width="70px"  Text='<%# Eval("lot")%>'></asp:TextBox>
...
<asp:TemplateField ItemStyle-Width = "100px"  HeaderText = "Cones" HeaderStyle-CssClass="col-lg-3 control-label" 
    ...
    <ItemTemplate>
        ...
        <asp:Label ID="lblcones" runat="server" Text='<%# Eval("cones")%>'></asp:Label>

    </ItemTemplate>

    <EditItemTemplate>

        <asp:TextBox ID="txtcones" runat="server" Width="70px" AutoPostBack="true"
            Text='<%# Eval("cones")%>' ontextchanged="txtcones_TextChanged"></asp:TextBox>
...
<asp:TemplateField ItemStyle-Width = "100px"  HeaderText = "Gross Wt" HeaderStyle-CssClass="col-lg-3 control-label" 
    ...
    <EditItemTemplate>
        ...
        <asp:TextBox ID="txtgrosswt" runat="server" Width="70px" Text='<%# Eval("Gross_Wt")%>'></asp:TextBox>
  ...
  <asp:TemplateField ItemStyle-Width = "100px"  HeaderText = "Nett Wt" HeaderStyle-CssClass="col-lg-3 control-label" 
    ...
    <EditItemTemplate>
        ...
        <asp:TextBox ID="txtnetwt" runat="server" Width="70px" Text='<%# Eval("Net_Wt")%>'></asp:TextBox>
...
<br />
 <div class="col-md-12">
  <div class="col-md-6">
                               ...
                               <div class="form-group"><label class="col-lg-3 control-label">Available KG</label>
   ...
   <ContentTemplate>
             ...
             <div class="col-md-6">
                           <div class="form-horizontal">
                               ...
                               <div class="form-group"><label class="col-lg-3 control-label">Total Cone</label>
                ...
                <asp:AsyncPostBackTrigger ControlID="Button5" EventName="Click"  />
                  <asp:AsyncPostBackTrigger ControlID="Button2" EventName="Click"  />
                   <asp:AsyncPostBackTrigger ControlID="GridView1"   />
                               ...
                               <div class="form-group">  <label class="col-lg-3 control-label">Total Nett wt</label>
