<%@ Page Language="C#" AutoEventWireup="true" CodeFile="location.aspx.cs" Inherits="Admin_Barcode_creation" %>
  ...
  <asp:Panel ID="Panel1" runat="server" class="panel0" BorderColor="Black" BorderStyle="Solid" BackColor="White" Direction="LeftToRight" style="display:none" 
   ...
   <div style="padding:12px; border:1px solid #e5e5e5;   border-radius:10px; background-color:#E6E6FA;color:#233445; font-size:15px; font-weight:400px; font-family: 'Open Sans',"HelveticaNeue", "Helvetica Neue", Helvetica, Arial,sans-serif; ">
        ...
        Search :<asp:TextBox ID="TextBox3" runat="server" OnTextChanged="TextBox3_TextChanged" ></asp:TextBox>
                   ...
                   <asp:BoundField HeaderText="Location ID" DataField="loc_id">
                     <HeaderStyle CssClass="Grd1" />
           <ItemStyle CssClass="Grd1" />
           </asp:BoundField>
           
               <asp:BoundField HeaderText="Location Code" DataField="loc_type" >
                 <HeaderStyle CssClass="Grd1" />
           <ItemStyle CssClass="Grd1" />
           </asp:BoundField>

                 <asp:BoundField HeaderText="Location Name" DataField="loc_name" >
                    <HeaderStyle CssClass="Grd1" />
           <ItemStyle CssClass="Grd1" />
           </asp:BoundField>
                    <asp:BoundField HeaderText="Location address" DataField="Loc_add" >
                      <HeaderStyle CssClass="Grd1" />
           <ItemStyle CssClass="Grd1" />
           </asp:BoundField>
...
<asp:UpdatePanel ID="UpdatePanel5" runat="server">
  ...
  <asp:Panel ID="Panel2" runat="server" class="panel0" BorderColor="Black" BorderStyle="Solid" BackColor="White" Direction="LeftToRight" style="display:none" 
   ...
   <div style="padding:12px; border:1px solid #e5e5e5;   border-radius:10px; background-color:#E6E6FA;color:#233445; font-size:15px; font-weight:400px; font-family: 'Open Sans',"HelveticaNeue", "Helvetica Neue", Helvetica, Arial,sans-serif; ">
                     <h3 style="font-size:20px; " class="control-label"> Add new location type <asp:ImageButton ID="ImageButton1" runat="server" ImageUrl="~/exit11.png" width="30px" height="30px" style="float:right" /></h3>
      ...
      <div class="tablestyles">
        ...
        <tr>
        <td>
            <asp:Label ID="Label15" runat="server" class="col-lg-6 control-label" Width="100px" Text="location Id"></asp:Label></td>
        <td>
            <asp:Label ID="Label16" runat="server" Text=""></asp:Label></td>
        </tr>
        <tr>
        <td>
            <asp:Label ID="Label17" runat="server" class="col-lg-6 control-label" Width="200px" Text="location type"></asp:Label></td>
        <td>
                ...
                <asp:AsyncPostBackTrigger ControlID="Button5" EventName="Click"  />
                  <asp:AsyncPostBackTrigger ControlID="Button2" EventName="Click"  />
                     <asp:AsyncPostBackTrigger ControlID="Button12" EventName="Click"  />
                                 ...
                                 <div class="form-group">  <label class="col-lg-3 control-label">Location name</label>
                ...
                <asp:AsyncPostBackTrigger ControlID="Button5" EventName="Click"  />
                  <asp:AsyncPostBackTrigger ControlID="Button2" EventName="Click"  />
                     <asp:AsyncPostBackTrigger ControlID="Button12" EventName="Click"  />
                                ...
                                <div class="form-group">  <label class="col-lg-3 control-label">location Address</label>
