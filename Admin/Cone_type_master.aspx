<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Cone_type_master.aspx.cs" Inherits="Admin_Email_marketting" %>
   ...
   <div class="col-md-6">
                 <div class="panel-body">
                           <div class="form-horizontal">
                               ...
                               <div class="form-group"><label class="col-lg-3 control-label">Cone Id</label>
   ...
   <ContentTemplate>
                ...
                <asp:AsyncPostBackTrigger ControlID="Button5" EventName="Click"  />
                  <asp:AsyncPostBackTrigger ControlID="Button2" EventName="Click"  />
                               ...
                               <div class="form-group">  <label class="col-lg-3 control-label">Cone Type</label>
                ...
                <asp:AsyncPostBackTrigger ControlID="Button5" EventName="Click"  />
                  <asp:AsyncPostBackTrigger ControlID="Button2" EventName="Click"  />
                     <asp:AsyncPostBackTrigger ControlID="Button12" EventName="Click"  />
                                 ...
                                 <div class="form-group">  <label class="col-lg-3 control-label">Cone Wt</label>
                ...
                <asp:AsyncPostBackTrigger ControlID="Button5" EventName="Click"  />
                  <asp:AsyncPostBackTrigger ControlID="Button2" EventName="Click"  />
                     <asp:AsyncPostBackTrigger ControlID="Button12" EventName="Click"  />
                                 ...
                                 <div class="form-group">  <label class="col-lg-3 control-label">Box Wt</label>
