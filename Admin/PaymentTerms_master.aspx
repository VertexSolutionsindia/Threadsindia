<%@ Page Language="C#" AutoEventWireup="true" EnableEventValidation="false" CodeFile="PaymentTerms_master.aspx.cs" Inherits="Settings" %>
                           ...
                           <ul class="nav nav-second-level collapse">
                            ...
                            <ul class="nav nav-second-level collapse">
                                ...
                                <ul class="nav nav-second-level collapse">
                                  ...
                                  <ul class="nav nav-second-level collapse">
                                    <li><a href="PoType.aspx">PO Type Master </a></li>

                           </ul>
                           
                                  <ul class="nav nav-second-level collapse">
                                    <li><a href="PaymentTerms_master.aspx">Payment Terms Master </a></li>
  ...
  <asp:Panel ID="Panel1" runat="server" class="panel0" BorderColor="Black" BorderStyle="Solid" BackColor="White" Direction="LeftToRight" style="display:none" 
   ...
   <div style="padding:12px; border:1px solid #e5e5e5;   border-radius:10px; background-color:#E6E6FA;color:#233445; font-size:15px; font-weight:400px; font-family: 'Open Sans',"HelveticaNeue", "Helvetica Neue", Helvetica, Arial,sans-serif; ">
        ...
        Search :<asp:TextBox ID="TextBox3" runat="server" OnTextChanged="TextBox3_TextChanged" ></asp:TextBox>
                   ...
                   <asp:BoundField HeaderText="Pay ID" DataField="Pay_id" HeaderStyle-CssClass="red" FooterStyle-CssClass="red" ItemStyle-CssClass="red"   />
                   <asp:BoundField HeaderText="Payment Terms" DataField="Payment_Terms" HeaderStyle-CssClass="red" FooterStyle-CssClass="red" ItemStyle-CssClass="red" />
   ...
   <div class="col-md-6">
                 <div class="panel-body">
                           <div class="form-horizontal">
                               ...
                               <div class="form-group"><label class="col-lg-3 control-label">Pay Id</label>
