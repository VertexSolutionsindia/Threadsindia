<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Party_master.aspx.cs" Inherits="Seetings" %>
...
<asp:Button ID="Button4" runat="server"  Text="ADD" class="btn btn-primary"></asp:Button> <span aria-hidden="true" class="glyphicon glyphicon-plus"></span> </a>
 ...
 <asp:UpdatePanel ID="UpdatePanel4" runat="server">
  ...
  <asp:Panel ID="Panel2" runat="server" class="panel0" BorderColor="Black" BorderStyle="Solid" BackColor="White" Direction="LeftToRight" style="display:none" 
   ...
   <div style="padding:12px; border:1px solid #e5e5e5;   border-radius:10px; background-color:#E6E6FA;color:#233445; font-size:15px; font-weight:400px; font-family: 'Open Sans',"HelveticaNeue", "Helvetica Neue", Helvetica, Arial,sans-serif; ">
                     <h3 style="font-size:20px; " class="control-label"> Add new Category  <asp:ImageButton ID="ImageButton1" runat="server" ImageUrl="~/exit11.png" width="30px" height="30px" style="float:right" /></h3>
      ...
      <div class="tablestyles">
        ...
        <tr>
        <td>
            <asp:Label ID="Label15" runat="server" class="col-lg-6 control-label" Width="100px" Text="Category Id"></asp:Label></td>
        <td>
            <asp:Label ID="Label16" runat="server" Text=""></asp:Label></td>
        </tr>
        <tr>
        <td>
            <asp:Label ID="Label17" runat="server" class="col-lg-6 control-label" Width="200px" Text="Category name"></asp:Label></td>
        <td>
            <asp:TextBox ID="TextBox21" runat="server" CssClass="paneltext0"></asp:TextBox></td>
        </tr>
        <tr>
        <td></td>
        <td>
  ...
  <div class="panel-body">
      ...
      <div class="col-md-6">
                 <div class="panel-body">
                           <div class="form-horizontal">
                               <br />
                               <div class="form-group"><label class="col-lg-3 control-label">Party Id</label>
   ...
   <ContentTemplate>
                                <asp:Button ID="Button8" runat="server" Text="New" 
                                ...
                                <div class="form-group"><label class="col-lg-3 control-label">Party code</label>
   ...
   <ContentTemplate>
                              ...
                              <Triggers>
                                  ...
                                  <div class="form-group"><label class="col-lg-3 control-label">Salutation</label>
   ...
   <ContentTemplate>
                              ...
                              <Triggers>
                                  ...
                                  <div class="form-group"><label class="col-lg-3 control-label">Control Account</label>
   ...
   <ContentTemplate>
                              ...
                              <Triggers>
                                 ...
                                 <div class="form-group"><label class="col-lg-3 control-label">Credit Limit</label>
   ...
   <ContentTemplate>
                              ...
                              <Triggers>
                                    ...
                                    <label class="col-lg-3 control-label">Credit Days</label>
                                      <div class="col-lg-3">
   ...
   <ContentTemplate>
                              ...
                              <Triggers>
                                ...
                                <div class="form-group"><label class="col-lg-3 control-label">Transaction Limit</label>
   ...
   <ContentTemplate>
                              ...
                              <Triggers>
                                 ...
                                 <div class="form-group"><label class="col-lg-3 control-label">Intro_By</label>
   ...
   <ContentTemplate>
                              ...
                              <Triggers>
                                ...
                                <div class="form-group"><label class="col-lg-3 control-label">Representative</label>
   ...
   <ContentTemplate>
                                    <asp:TextBox ID="TextBox11" runat="server" TextMode="MultiLine" Width="100%"></asp:TextBox>
                                     </ContentTemplate>
                              <Triggers>
                                     <asp:AsyncPostBackTrigger ControlID="Button7" EventName="Click"  />
                                     <asp:AsyncPostBackTrigger ControlID="Button1" EventName="Click"  />
                    ...
                    <asp:UpdatePanel ID="UpdatePanel5" runat="server">
                             ...
                             <ContentTemplate>
                              ...
                              <Triggers>
                                 ...
                                 <div class="form-group"><label class="col-lg-3 control-label">Pan</label>
                             ...
                             <ContentTemplate>
                              ...
                              <Triggers>
                                 ...
                                 <div class="form-group"><label class="col-lg-3 control-label">Bank</label>
                             ...
                             <ContentTemplate>
                              ...
                              <Triggers>
                                   ...
                                   <div class="form-group"><label class="col-lg-3 control-label">Bank A/C No</label>
